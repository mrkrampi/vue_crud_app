                ...
                <v-container grid-list-md>
                    <v-layout wrap>
                        <v-flex xs12 sm12 md12>
                            <v-text-field v-model="item.name" label="Назва категорії"></v-text-field>
                        </v-flex>
                        <v-flex xs12 sm12 md12>
                            <v-text-field v-model="item.description" label="Назва категорії"></v-text-field>
                        </v-flex>
                    </v-layout>
                </v-container>
            </v-card-text>
        ...
        methods: {
            ...
            save() {
                axios({
                    ...
                    url: "api/cycle_of_works/" + (this.item.id || ""),
                    data: this.item,
                    headers: {
