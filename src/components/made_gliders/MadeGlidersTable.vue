...
<script>
    ...
    export default {
        name: "MadeGlidersTable",
        data() {
            return {
                headers: [
                    {text: 'Назва планера', value: 'name', sortable: false},
        ...
        methods: {
            deleteProduct(product) {
                axios.delete("api/made_gliders/" + product.id)
                    .then(() => {
